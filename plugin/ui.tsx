...
import {context, htmlToFigma} from './htmlParser/browser';
    ...
    return (
      <IntlProvider messages={this.currentLanguage === 'en' ? en : ru} locale={this.currentLanguage} defaultLocale="en">
        ...
        >
          ...
          {/*          }}*/}
          {/*        >*/}
          {/*          <FormattedMessage id="title" defaultMessage="Turn your design into code " />*/}
          ...
          {/*        }}*/}
          {/*      >*/}
          {/*        <FormattedMessage id="description" defaultMessage="Convert your Figma designs into responsive code" />*/}
          {/*      </div>*/}
          ...
          {/*              <span style={{ fontWeight: 'bold' }}>Note: this plugin is not magic.</span> We attempt to import*/}
          {/*              your design as best possible. You may need to make final adjustments after import, including*/}
          ...
          {/*      ) : (*/}
          {/*        <>*/}
          {/*          {this.figmaCheckList && Boolean(Object.keys(this.figmaCheckList).length) ? (*/}
          {/*            <div>*/}
          {/*              <div*/}
          {/*                style={{*/}
          {/*                  fontWeight: 'bold',*/}
          ...
          {/*              <CircularProgress disableShrink style={{ margin: '10 auto' }} />*/}
          {/*            </div>*/}
          {/*          )}*/}
          ...
          {/*                  rel="noopenner"*/}
          {/*                >*/}
          {/*                  <FormattedMessage id="autolayout" defaultMessage="autolayout" />*/}
          {/*                </a>*/}
          {/*                <FormattedMessage id="importLayerHelp2" defaultMessage=" and vectors should be " />*/}
          {/*                <a*/}
          {/*                  style={{*/}
          {/*                    color: themeVars.colors.primary,*/}
          {/*                  }}*/}
          ...
          {/*                  rel="noopenner"*/}
          {/*                >*/}
          {/*                  <FormattedMessage id="rasterizeVectors" defaultMessage="rasterized" />*/}
          {/*                </a>*/}
          {/*                <div*/}
          {/*                  style={{*/}
          {/*                    display: 'flex',*/}
          ...
          {/*                    }}*/}
          {/*                  >*/}
          {/*                    <FormattedMessage id="clearErrors" defaultMessage="Clear errors" />*/}
          {/*                  </Button>*/}
          {/*                </div>*/}
          {/*              </div>*/}
          {/*            </div>*/}
          ...
          {/*                        onChange={(e) => (this.inDevMode = e.target.checked)}*/}
          {/*                      />*/}
          {/*                    }*/}
          {/*                    label={*/}
          {/*                      <span*/}
          ...
          {/*                        }}*/}
          {/*                      >*/}
          {/*                        <FormattedMessage id="devMode" defaultMessage="Use Dev Mode" />*/}
          {/*                      </span>*/}
          {/*                    }*/}
          ...
          {/*                    color="primary"*/}
          {/*                  >*/}
          {/*                    <FormattedMessage id="getCode" defaultMessage="Get Code" />*/}
          {/*                  </Button>*/}
          {/*                </div>*/}
          {/*              </Tooltip>*/}
          {/*            </>*/}
          ...
          {/*              disabled={!this.selection.length}*/}
          {/*            >*/}
          {/*              <FormattedMessage id="downloadJson" defaultMessage="Download JSON" />*/}
          {/*            </Button>*/}
          {/*          )}*/}
          {/*        </>*/}
          {/*      )}*/}
                ...
                {this.loading ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {/*  }}*/}
                      {/*>*/}
                      {/*  <FormattedMessage id="chromeExtension" defaultMessage="Chrome Extension" />*/}
                      {/*</div>*/}
                      {/*<div*/}
                      {/*  style={{*/}
                      {/*    fontSize: 12,*/}
                      ...
                      {/*    }}*/}
                      {/*  >*/}
                      {/*    Want to capture a page that you need to navigate to or is behind an auth wall? Then the Chrome*/}
                      ...
                      {/*      target="_blank"*/}
                      {/*    >*/}
                      {/*      <FormattedMessage id="chromeExtensionLink" defaultMessage="chrome extension" />*/}
                      {/*    </a>*/}
                      {/*  </p>*/}
                      ...
                      {/*        const onFocus = () => {*/}
                      {/*          setTimeout(() => {*/}
                      {/*            if (input.parentElement && (!input.files || input.files.length === 0)) {*/}
                      {/*              done();*/}
                      {/*            }*/}
                      {/*          }, 200);*/}
                      {/*        };*/}
                      ...
                      {/*      }}*/}
                      {/*    >*/}
                      {/*      <FormattedMessage id="uploadLink" defaultMessage=" upload here " />*/}
                      {/*    </a>*/}
                      {/*  </p>*/}
                      {/*</div>*/}
                    </div>
          ...
          {/*    </div>*/}
          {/*  )}*/}
          {/*<a style={{ display: 'flex' }} href="https://www.builder.io?utm_source=figma" target="_blank">*/}
          {/*  <img*/}
          {/*    width={170}*/}
          {/*    height={56}*/}
          {/*    style={{*/}
          ...
          {/*    <span onClick={() => this.handleDevModeClick()}>&nbsp;components</span>.*/}
          {/*  </span>*/}
          {/*</p>*/}
